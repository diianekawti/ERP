<div x-data="modalProdukManager()"
     x-show="isOpen"
     @open-produk-modal.window="openModal($event.detail)"
     @close-produk-modal.window="closeModal()"
     x-cloak
    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full"
            ...
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
                ...
                <button @click="closeModal()" type="button" class="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 focus:outline-none">
            ...
            <div class="px-6 py-4">
                <form id="produk-form" @submit.prevent="submitForm()" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            <label for="kode" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Kode Produk</label>
                        ...
                        <div>
                            <label for="product_sku" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">SKU</label>
                        ...
                        <div>
                            <label for="nama" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nama <span class="text-red-600">*</span></label>
                        ...
                        <div>
                            <label for="kategori_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Kategori <span class="text-red-600">*</span></label>
                        ...
                        <div>
                            <label for="jenis_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Jenis</label>
                        ...
                        <div>
                            <label for="satuan_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Satuan <span class="text-red-600">*</span></label>
                        ...
                        <div>
                            <label for="merek" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Merek</label>
                            <input type="text" name="merek" id="merek" x-model="formData.merek"
                                   class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm text-sm">
                        </div>

                        <div>
                            <label for="sub_kategori" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Sub Kategori</label>
                        ...
                        <div>
                            <label for="type_material" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tipe Material</label>
                            <input type="text" name="type_material" id="type_material" x-model="formData.type_material"
                                   class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm text-sm">
                        </div>

                        <!-- Kualitas, Harga -->
                        <div>
                            <label for="kualitas" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Kualitas</label>
                            <input type="text" name="kualitas" id="kualitas" x-model="formData.kualitas"
                                   class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm text-sm">
                        </div>

                        <div>
                            <label for="harga_jual" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Harga Jual <span class="text-red-600">*</span></label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-gray-500 dark:text-gray-400 text-xs">Rp</span>
                                <input type="number" 
                                       name="harga_jual" 
                                       id="harga_jual" 
                                       x-model="formData.harga_jual" 
                                       required
                                       min="0"
                        ...
                        <div>
                            <label for="harga_beli" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Harga Beli</label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-gray-500 dark:text-gray-400 text-xs">Rp</span>
                                <input type="number" 
                                       name="harga_beli" 
                                       id="harga_beli" 
                                       x-model="formData.harga_beli" 
                                       min="0"
                                       placeholder="0"
                                       class="pl-9 w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm text-sm">
                            </div>
                        ...
                        <div>
                            <label for="stok_minimum" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Stok Minimum</label>
                            <input type="number" name="stok_minimum" id="stok_minimum" x-model="formData.stok_minimum" min="0"
                                   class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm text-sm">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-1 text-xs text-red-600 dark:text-red-400" x-show="errors.deskripsi" x-text="errors.deskripsi"></p>
                    </div>
                    
                    <!-- Gambar -->
                    <div class="mb-4">
                        <label for="gambar" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Gambar Produk</label>
                        
                        <!-- Preview gambar yang sudah ada -->
                        <div x-show="imagePreview || formData.current_image" class="mb-3">
                            <div class="relative w-32 h-32 bg-gray-100 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600 overflow-hidden">
                                <img x-bind:src="imagePreview || formData.current_image" alt="Preview gambar" class="w-full h-full object-cover">
                            ...
                            <label for="gambar" 
                                ...
                                <div class="flex flex-col items-center justify-center pt-7">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 002-2V6a2 2 2z" />
                                    </svg>
                                    <p class="pt-1 text-sm text-gray-500 dark:text-gray-400">Upload gambar</p>
                                </div>
                                <input id="gambar" name="gambar" type="file" class="hidden" @change="handleImageUpload($event)">
                            </label>
                        </div>
                        
                        <div class="mt-2 flex items-center" x-show="imagePreview || formData.current_image">
                            <label for="gambar" class="px-3 py-1.5 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 cursor-pointer">
                                Ganti Gambar
                            </label>
                        </div>
                        <p class="mt-1 text-xs text-red-600 dark:text-red-400" x-show="errors.gambar" x-text="errors.gambar"></p>
                    </div>
        ...
        return {
            ...
            openModal(data = {}) {
                ...
                if (data.mode === 'edit' && data.product) {
                    ...
                    this.formData.is_active = data.product.is_active;
            ...
            submitForm() {
                ...
                .then(data => {
                    ...
                    window.dispatchEvent(new CustomEvent('refresh-product-table', {
                        detail: { action: this.isEdit ? 'update' : 'create', product: data.product }
                    }));
