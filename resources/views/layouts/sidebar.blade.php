    ...
    <div
        ...
        <a href="{{ route('dashboard') }}" class="flex items-center">
            <div class="flex items-center">
                <img src="{{ asset('img/Logo_nama2.jpg') }}" alt="Logo PT Sinar Surya Semestaraya" class="h-auto w-auto">
            </div>
        </a>
    </div>
        ...
        <nav class="flex-1 py-4 px-2 space-y-1" x-data="{
            ...
            <div>
                ...
                <div x-show="activeDropdown === 'inventaris'" x-cloak class="mt-1 space-y-1 pl-11">
                    <a href="#"
                        class="{{ request()->is('inventaris/stok') ? 'text-blue-700 dark:text-blue-400 font-semibold' : 'text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white' }} group flex items-center px-3 py-2 text-sm rounded-md transition-colors"><span>Stok
                            Barang</span></a>
                    <a href="#"
                ...
                <div x-show="activeDropdown === 'pembelian'" x-cloak class="mt-1 space-y-1 pl-11">
                    ...
                    <a href="#"
                        class="{{ request()->is('pembelian/po') ? 'text-blue-700 dark:text-blue-400 font-semibold' : 'text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white' }} group flex items-center px-3 py-2 text-sm rounded-md transition-colors"><span>Purchase
                            Order (PO)</span></a>
                    <a href="#"
                        class="{{ request()->is('pembelian/grn') ? 'text-blue-700 dark:text-blue-400 font-semibold' : 'text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white' }} group flex items-center px-3 py-2 text-sm rounded-md transition-colors"><span>Penerimaan
                            Barang (GRN)</span></a>
                    <a href="#"
            ...
            <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                ...
                <div x-show="activeDropdown === 'pengaturan'" x-cloak class="mt-1 space-y-1 pl-11">
                    ...
                    <a href="/pengaturan/hak-akses"
                        class="{{ request()->is('pengaturan/peran') ? 'text-blue-700 dark:text-blue-400 font-semibold' : 'text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white' }} group flex items-center px-3 py-2 text-sm rounded-md transition-colors"><span>Peran
                            & Hak Akses</span></a>
                    <a href="#"
